...
function x0() {
    ...
    const { copy } = no();
    const [autoMode, setAutoMode] = x.useState(false); // New state to track Auto Mode
    const autoModeInterval = x.useRef(null); // Ref to store interval ID
    ...
    // Function to handle toggling Auto Mode
    const toggleAutoMode = () => {
        if (autoMode) {
            // Turn off Auto Mode
            clearInterval(autoModeInterval.current);
            setAutoMode(false);
            setStatus("idle"); // Stop any ongoing generation
            ...
            v.jsxs(Gn, {
                children: [
                    ...
                    v.jsxs("input", {
                        ...
                        max: 4,
                        type: 'number',
                        disabled: autoMode // Disable input in Auto Mode
                    })
                ]
            }),
            v.jsx(Xn, {
                ...
                children: [
                    v.jsx(Jn, {
                        children: v.jsxs(He, {
                            ...
                            disabled: "wait" === status || autoMode, // Disable when Auto Mode is active
                            children: [
                    ...
                    v.jsx(He, {
                        ...
                        children: autoMode ? "Off Auto Mode" : "Auto Mode" // Toggle button text
                    })
                ]
            })
        ]
