...
function N0() {
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            r("wait");
            l(0);
            const codes = await Promise.all(Array.from({ length: numberOfCodes }, () => Io.generate()));
            t(codes);
            r("done");
            l(100);
            const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
            ...
            v.jsx(Xn, {
                children: v.jsxs("ul", {
                    ...
                    children: [
                        ...
                        v.jsxs("p", { className: "text-center font-medium mt-4", children: [o, "%"] }),
                        v.jsx(Zn, { value: o, className: "progressbar" })
                    ]
                })
            }),
            v.jsxs("div", {
...
function R0() {
    const [e, t] = x.useState([null, null, null, null]);
    const n = Ke(u => u.status);
    const r = Ke(u => u.setStatus);
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            r("wait");
            l(0);
            const codes = await Promise.all(Array.from({ length: numberOfCodes }, () => Ro.generate()));
            t(codes);
            r("done");
            l(100);
            const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
...
function mud() {
    ...
    const handleGenerate = async () => {
        const numberOfCodes = parseInt(document.getElementById("mud_num_of_code").value);
        if (isNaN(numberOfCodes)) {
            tt("Please enter a number");
            return;
        } else if (numberOfCodes < 1 || numberOfCodes > 30) {
        ...
        try {
            ...
            setCurrentStatus("wait");
            setProgress(0);
            const newCodes = await Promise.all(Array.from({ length: numberOfCodes }, () => mud3.generate()));
            setCodes(newCodes);
            setCurrentStatus("done");
            setProgress(100);
            const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
...
function mow() {
    ...
    const handleGenerate = async () => {
        const numberOfCodes = parseInt(document.getElementById("mow_num_of_code").value);
        if (isNaN(numberOfCodes)) {
            tt("Please enter a number");
            return;
        } else if (numberOfCodes < 1 || numberOfCodes > 30) {
        ...
        try {
            ...
            setCurrentStatus("wait");
            setProgress(0);
            const newCodes = await Promise.all(Array.from({ length: numberOfCodes }, () => mow3.generate()));
            setCodes(newCodes);
            setCurrentStatus("done");
            setProgress(100);
            const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
...
const cafe1 = 'bc0971b8-04df-4e72-8a3e-ec4dc663cd11',
cafe2 = 'bc0971b8-04df-4e72-8a3e-ec4dc663cd11',
cafe3 = new ro(cafe1,cafe2);
...
function cafe() {
    ...
    const handleGenerate = async () => {
        const numberOfCodes = parseInt(document.getElementById("cafe_num_of_code").value);
        if (isNaN(numberOfCodes)) {
            tt("Please enter a number");
            return;
        } else if (numberOfCodes < 1 || numberOfCodes > 30) {
        ...
        try {
            ...
            setCurrentStatus("wait");
            setProgress(0);
            const newCodes = await Promise.all(Array.from({ length: numberOfCodes }, () => cafe3.generate()));
            setCodes(newCodes);
            setCurrentStatus("done");
            setProgress(100);
            const generatedCodeCount = parseInt(localStorage.getItem('generatedCodeCount') || '0');
