...
function A0() {
   const [e, t] = x.useState([null, null, null, null, null, null , null,null]),
                  ...
                  v.jsxs(ft, {
                     onClick: async function a() {
                        try {
                           ...
                           l(0);
                           s();
                           const c = await Promise.all([xo.generate(), xo.generate(), xo.generate(), xo.generate(),xo.generate(), xo.generate(), xo.generate(), xo.generate()]);
                           t(c);
                           r("done");
                           l(100);
                        } catch (c) {
